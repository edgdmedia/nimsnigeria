...
export default function RegistrationPage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 relative overflow-hidden bg-linear-to-br from-[#16301d] via-[#204027] to-[#2b5533] flex items-center justify-center pt-40 px-8 pb-27.5">
        ...
        <div className="relative max-w-170 text-center text-white z-10">
          <span className="inline-flex w-19.5 h-19.5 rounded-full bg-white items-center justify-center shadow-[0_14px_34px_rgba(0,0,0,0.3)]">
          ...
          <div className="flex gap-3.5 justify-center">
            ...
            <a href="https://instagram.com/nimsnigeria" target="_blank" rel="noopener noreferrer" title="Instagram" className="w-13 h-13 rounded-full border border-white/30 flex items-center justify-center font-display font-bold text-white bg-white/5 hover:bg-white/10 transition-colors">IG</a>
            <a href="https://facebook.com/nimsnigeria" target="_blank" rel="noopener noreferrer" title="Facebook" className="w-13 h-13 rounded-full border border-white/30 flex items-center justify-center font-display font-bold text-white bg-white/5 hover:bg-white/10 transition-colors">f</a>
            <a href="https://x.com/nimsnigeria" target="_blank" rel="noopener noreferrer" title="X" className="w-13 h-13 rounded-full border border-white/30 flex items-center justify-center font-display font-bold text-white bg-white/5 hover:bg-white/10 transition-colors">X</a>
          </div>
