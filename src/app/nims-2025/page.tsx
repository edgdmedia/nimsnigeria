  ...
  <main className="grow">
    ...
    <section className="w-full bg-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-5 text-center">
            ...
            <a className="bg-primary text-white font-sans font-bold text-sm md:text-base rounded-[10px] px-8 py-3 hover:bg-green-700 transition shadow-md hover:shadow-lg inline-flex items-center gap-2" href="./gallery.html">
