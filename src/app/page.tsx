      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-brand-deep min-h-screen flex items-center pt-20">
          ...
          <div className="relative z-20 max-w-7xl mx-auto px-5 md:px-8 w-full pt-16 pb-24">
            <div className="max-w-250">
              <h1 className="font-display font-black uppercase tracking-tight leading-none text-5xl md:text-6xl text-white">
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-[1fr_1.04fr] gap-8 lg:gap-14 items-center mt-6 lg:mt-14">
              <div className="w-full">
                <p className="text-base lg:text-lg leading-relaxed text-white/90 mb-2 lg:mb-8">
                  <span className="font-display font-bold tracking-widest text-xs lg:text-xs uppercase text-[#79c088] block mb-1.5 lg:mb-2">Theme</span>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-2.5 md:gap-4 md:px-5 md:py-4 rounded-lg md:bg-white/10 md:border md:border-white/20 text-white font-display font-bold text-sm lg:text-[14px] tracking-wide w-full">
        ...
        <section className="bg-surface-alt border-b border-border py-12 px-5">
          <div className="max-w-7xl mx-auto text-center">
            <p className="font-display font-bold text-xs tracking-widest uppercase text-ink-500 m-0">Convened by</p>
        ...
        <section className="relative py-32 px-8">
          ...
          <div className="relative z-20 max-w-250 mx-auto text-center text-white">
            ...
            <p className="font-display font-bold text-4xl leading-snug tracking-tight m-0">
              We are no longer introducing the concept. We are executing the vision.
            </p>
            <p className="mt-7 text-base tracking-wider text-white/80">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-14">
              {[
                ...
                <div key={i} className="bg-white border border-border rounded-xl p-8 shadow-sm">
                  ...
                  <h3 className="font-display font-extrabold text-xl mt-5 mb-2.5 text-ink-900">{item.title}</h3>
        ...
        <section id="speakers" className="section-shell bg-[#16301d] relative overflow-hidden">
          ...
          <div className="relative max-w-250 mx-auto text-center text-white">
            <SectionHeading 
              ...
              onDark={true}
            />
            <p className="text-lg leading-relaxed text-white/85 max-w-180 mx-auto mt-6">
