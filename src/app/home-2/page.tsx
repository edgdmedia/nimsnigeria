  ...
  <main className="grow">
    ...
    <div className="relative flex min-h-[100vh] flex-row p-8 lg:p-12 items-center overflow-hidden" id="fefd2c2">
      ...
      <div className="max-w-7xl mx-auto w-full z-10">
        {/*  Hero Text Content  */}
        <div className="w-full md:w-[80%] flex flex-col justify-center gap-0 z-10">
          <div>
          ...
          <div className="flex flex-row justify-start items-center mt-4">
            <div>
              <h6 className="font-heading font-semibold tracking-[2.5px] text-accent m-0 uppercase text-lg">THEME</h6>
            </div>
            <div className="w-16 border-t-2 border-accent ml-4"></div>
          </div>
          <div className="mt-4 mb-2 max-w-3xl">
            <h4 className="font-heading font-medium text-white text-[22px] md:text-[28px] leading-tight m-0 drop-shadow-md">
    ...
    {/*  Info & Action Section  */}
    <div className="relative flex flex-col -mt-15.5 pb-12 px-8 lg:px-12 z-20 max-w-7xl mx-auto w-full">
      <div>
        {/*  Info Card  */}
        <div
          ...
          <div
            ...
            <div className="flex gap-4 flex-wrap mt-6">
              <a className="bg-primary text-white font-sans font-semibold text-sm md:text-base rounded-full px-8 py-3.5 shadow-[0_8px_20px_-5px_rgba(34,197,94,0.4)] hover:bg-green-600 hover:-translate-y-1 transition-all duration-300 w-full md:w-auto text-center"
              href="/partners">
              Become a Partner
            </a>
            <a className="bg-gray-100 text-gray-800 border border-gray-200 font-sans font-semibold text-sm md:text-base rounded-full px-8 py-3.5 hover:bg-gray-200 hover:-translate-y-1 transition-all duration-300 w-full md:w-auto text-center"
              href="/about">
              Learn About NIMS
            </a>
            </div>
    ...
    <div className="hidden flex-col py-12 md:py-12.5 px-5 md:px-12.5 max-w-7xl mx-auto w-full items-center bg-gray-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 w-full">
            ...
            {/*  Speaker 2  */}
            <div className="flex flex-col items-center bg-transparent md:bg-white p-5 rounded-[10px] md:shadow-sm md:hover:shadow-md transition-shadow">
                <img src="/images/wale.webp" alt="Wale Tinubu, CON" className="w-full max-w-75 aspect-square object-cover rounded-[10px] mb-4" />
                <div className="w-31.5 border-t border-black my-4"></div>
            ...
            {/*  Speaker 3  */}
            <div className="flex flex-col items-center bg-transparent md:bg-white p-5 rounded-[10px] md:shadow-sm md:hover:shadow-md transition-shadow">
                <img src="/images/6.webp" alt="Mr. Roosevelt Ogbonna FCA, CFA" className="w-full max-w-75 aspect-square object-cover rounded-[10px] mb-4" />
                <div className="w-31.5 border-t border-black my-4"></div>
            ...
            {/*  Speaker 4  */}
            <div className="flex flex-col items-center bg-transparent md:bg-white p-5 rounded-[10px] md:shadow-sm md:hover:shadow-md transition-shadow">
                <img src="/images/zaaa.webp" alt="Dr. Zacch Adedeji" className="w-full max-w-75 aspect-square object-cover rounded-[10px] mb-4" />
                <div className="w-31.5 border-t border-black my-4"></div>
            ...
            {/*  Speaker 5  */}
            <div className="flex flex-col items-center bg-transparent md:bg-white p-5 rounded-[10px] md:shadow-sm md:hover:shadow-md transition-shadow">
                <img src="/images/9.webp" alt="Amb Nura Abba Rimi" className="w-full max-w-75 aspect-square object-cover rounded-[10px] mb-4" />
                <div className="w-31.5 border-t border-black my-4"></div>
            ...
            {/*  Speaker 6  */}
            <div className="flex flex-col items-center bg-transparent md:bg-white p-5 rounded-[10px] md:shadow-sm md:hover:shadow-md transition-shadow">
                <img src="/images/bambam.webp" alt="Bamanga Usman Jada" className="w-full max-w-75 aspect-square object-cover rounded-[10px] mb-4" />
                <div className="w-31.5 border-t border-black my-4"></div>
