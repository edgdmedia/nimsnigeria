        ...
        <section className="py-24 px-5 bg-surface-alt">
          <div className="max-w-7xl mx-auto px-5 md:px-8 grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-14 items-start">
            <div>
              ...
              />
              <p className="text-[17px] leading-[1.65] text-ink-800 mt-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <div key={i} className="bg-white border border-border rounded-lg px-5 py-4 flex gap-3 items-center shadow-sm">
                  ...
                  <span className="text-[15.5px] text-ink-800">{item}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-11">
              ...
              <div className="border border-border rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="p-7 md:p-8 bg-white">
                  <div className="font-display font-extrabold text-xs tracking-[0.12em] uppercase text-accent mb-3">Morning</div>
                  <ul className="list-disc pl-5 mb-6 text-[15.5px] leading-[1.7] text-ink-800 marker:text-ink-300">
                  ...
                  <div className="font-display font-extrabold text-xs tracking-[0.12em] uppercase text-accent mb-3">Afternoon</div>
                  <ul className="list-disc pl-5 text-[15.5px] leading-[1.7] text-ink-800 marker:text-ink-300">
