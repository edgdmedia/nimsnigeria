      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-linear-to-br from-[#16301d] via-[#204027] to-[#2b5533] pt-37.5 px-8 pb-22">
          ...
          <div className="relative max-w-7xl mx-auto px-5 md:px-8">
            ...
            <h1 className="font-display font-black uppercase tracking-tight leading-[0.98] text-5xl md:text-[60px] text-white m-0">About the Summit</h1>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-5 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-7">
            <div className="bg-linear-to-br from-brand-dark to-brand text-white rounded-2xl p-10 md:p-12 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-lg leading-[1.7] text-white/90 mt-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-11">
              {[
                ...
                <div key={i} className="bg-white border border-border rounded-lg p-6 flex gap-4 items-start shadow-sm hover:shadow-md transition-shadow">
                  <span className="text-accent text-xl font-black leading-[1.2]">✓</span>
                  <span className="text-[16.5px] leading-relaxed text-ink-800">{item}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative max-w-250 mx-auto px-5 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-14">
              <div className="bg-white/5 border border-white/10 rounded-xl p-9">
                ...
                <p className="text-[16.5px] leading-[1.65] text-white/85 mt-4">
          ...
          <div className="max-w-7xl mx-auto px-5 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <Link href="/programme" className="block bg-white border border-border rounded-xl p-8 shadow-sm hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
                <h3 className="font-display font-extrabold text-[22px] m-0 text-ink-900 group-hover:text-brand transition-colors">NIMS 2026</h3>
                <p className="text-base leading-[1.6] text-ink-600 my-3">Learn about this year's theme, programme and expected outcomes.</p>
                <span className="font-display font-bold text-[13px] tracking-[0.08em] uppercase text-accent">View Programme &rarr;</span>
              </Link>
              <Link href="/nims-2025" className="block bg-white border border-border rounded-xl p-8 shadow-sm hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
                <h3 className="font-display font-extrabold text-[22px] m-0 text-ink-900 group-hover:text-brand transition-colors">NIMS 2025</h3>
                <p className="text-base leading-[1.6] text-ink-600 my-3">Explore highlights, speakers, gallery and key outcomes from the inaugural summit.</p>
                <span className="font-display font-bold text-[13px] tracking-[0.08em] uppercase text-accent">Revisit 2025 &rarr;</span>
              </Link>
              <Link href="/sponsors-exhibitors" className="block bg-white border border-border rounded-xl p-8 shadow-sm hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
                <h3 className="font-display font-extrabold text-[22px] m-0 text-ink-900 group-hover:text-brand transition-colors">Partners & Sponsors</h3>
                <p className="text-base leading-[1.6] text-ink-600 my-3">Discover opportunities to partner with NIMS and support Nigeria's industrial transformation.</p>
                <span className="font-display font-bold text-[13px] tracking-[0.08em] uppercase text-accent">Get Involved &rarr;</span>
              </Link>
            </div>
          </div>
        </section>
